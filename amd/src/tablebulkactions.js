 ...
 * @module     block_evasys_sync/tablebulkactions
...
export function init() {
    const checkboxes = document.querySelectorAll('input[name="bulkcheckbox-select"]');

    const action = document.querySelectorAll('*[data-evasys-action]');
    action.forEach((a) => {
        a.onclick = (e) => {
            e.preventDefault();
            let data = [
